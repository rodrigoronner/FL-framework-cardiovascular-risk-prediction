...
Per-client batch size recommended by the Mamdani fuzzy controller (`dpfedadam/fuzzy_fairness.py`) from (dataset size, current epsilon), vs. fixed L=32, at 100 rounds:
